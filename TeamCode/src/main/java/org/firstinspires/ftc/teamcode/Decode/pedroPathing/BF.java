...
@Autonomous(name = "Blue Far Pedro V2", group = "Examples")
@Configurable
public class BF extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(56.1, 6, Math.toRadians(90)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Launch0 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(56.100, 6.000),

                                    new Pose(58.700, 11.000)
                            )
            ...
            Pickup1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(58.700, 11.000),
                                    new Pose(54.089, 41.000),
                                    new Pose(59.308, 34.449),
                                    new Pose(8.850, 35.636)
                            )
            ...
            Pickup2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(58.700, 11.000),
                                    new Pose(53.377, 57.410),
                                    new Pose(67.374, 60.494),
                                    new Pose(8.850, 59.1)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(180))
            ...
            Pickup3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(58.700, 11.000),
                                    new Pose(57.173, 91.572),
                                    new Pose(64.053, 83.031),
