...
import org.firstinspires.ftc.teamcode.Decode.RedLimelightAutoAim;

import java.util.TimerTask;


@Autonomous(name = "Red Far Pedro V2", group = "Examples")
@Configurable
public class RF extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(87.9, 6, Math.toRadians(90)));
...
//        }
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Launch0 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(87.900, 6.000),

                                    new Pose(85.300, 11.000)
                            )
            ...
            Pickup1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(85.300, 11.000),
                                    new Pose(89.911, 41.000),
                                    new Pose(84.692, 34.449),
                                    new Pose(136.200, 35.600)
                            )
            ...
            Pickup2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(85.300, 11.000),
                                    new Pose(90.700, 57.410),
                                    new Pose(76.626, 60.494),
                                    new Pose(135.200, 59.100)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(0))
            ...
            Pickup3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(85.300, 11.000),
                                    new Pose(86.800, 91.572),
                                    new Pose(79.900, 83.031),
                                    new Pose(128.700, 84.000)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(0))
    ...
    public class PreAim extends TimerTask {

        @Override
        public void run() {launcher.RFPreloadAim();}
    }
