...
@Autonomous(name = "Red Close Pedro V2", group = "Examples")
@Configurable
public class RC extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(123.5, 121.5, Math.toRadians(38)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Pickup2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(84.500, 84.000),
                                    new Pose(83.700, 58.596),
                                    new Pose(85.900, 59.071),
                                    new Pose(86.700, 59.759),
                                    new Pose(135.150, 59.200)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(0))
            ...
            Pickup3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    ...
                                    new Pose(84.700, 35.822),
                                    new Pose(88.700, 35.137),
                                    new Pose(135.150, 35.822)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(0))
