...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
            ...
            .translationalPIDFCoefficients(new PIDFCoefficients(0.22, 0, 0.035, 0.02))
            .secondaryTranslationalPIDFCoefficients(new PIDFCoefficients(0.22, 0, 0.035, 0.02))
            ...
            .drivePIDFCoefficients(new FilteredPIDFCoefficients(0.02, 0, 0.005, 0.6, 0.01))
