...
@Autonomous(name = "DONT USE Red Close Pedro", group = "Examples")
@Configurable
public class PedroPathingDecodeAuto4nmousMaroonDecreasedDistance extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(120.3, 119.3, Math.toRadians(225)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Launch0 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(120.300, 119.328), new Pose(86.200, 85.500))
                    )
            ...
            Pickup1 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(86.200, 85.500),
                                    new Pose(93.200, 83.506),
                                    new Pose(124.500, 83.743)
                            )
                    )
            ...
            Launch1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(124.500, 83.743), new Pose(86.200, 85.500))
                    )
            ...
            Pickup2 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(86.200, 85.500),
                                    new Pose(85.600, 57.173),
                                    new Pose(85.900, 59.071),
                                    new Pose(124.500, 59.783)
                            )
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
            ...
            Launch2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(124.500, 59.783), new Pose(86.200, 85.500))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(225))
                    .build();
            ...
            Pickup3 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(86.200, 85.500),
                                    new Pose(86.100, 29.417),
                                    new Pose(86.100, 36.297),
                                    new Pose(124.500, 35.822)
                            )
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
            ...
            Launch3 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(124.500, 35.822), new Pose(86.200, 85.500))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(225))
                    .build();
            ...
            Park = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(86.200, 85.500), new Pose(128.000, 95.600))
                    )
